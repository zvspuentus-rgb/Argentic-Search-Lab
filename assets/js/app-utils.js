    ...
    function getProviderRuntime() {
      ...
      const map = {
        ...
        anthropic: { provider, model, base: $("anthropicBase")?.value?.trim() || "https://api.anthropic.com/v1", apiKey: $("anthropicKey")?.value || "" },
        gemini: { provider, model, base: $("geminiBase")?.value?.trim() || "https://generativelanguage.googleapis.com/v1beta", apiKey: $("geminiKey")?.value || "" }
      };
